...
public class Generator {
    ...
    public static User generateUser(){
        final User person = new User();
        person.setUsername("Josef" + Integer.toString(Generator.randomInt()));
        person.setPassword("Password" + Integer.toString(Generator.randomInt()));
        person.setFirstName("Josef" + Integer.toString(Generator.randomInt()));
        person.setLastName("Čapek" + Integer.toString(Generator.randomInt()));
        person.setEmailAddress("josefcapek" + Integer.toString(Generator.randomInt()) + "@gmail.com");
        person.setInstitution(generateInstitution());
        return person;
    }
