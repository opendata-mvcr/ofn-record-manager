...
export default {
    ...
    'messages': {
        ...
        'dashboard.records-tile': 'View forms',
        ...
        'institution.patients.panel-title': 'Institution\'s forms',
        ...
        'records.panel-title': 'Forms',
        'records.id': 'Id',
        'records.local-name': 'Form identifier',
        'records.completion-status': 'Completion status',
        'records.completion-status-tooltip.complete': 'All required fields of the form have been filled out.',
        'records.completion-status-tooltip.incomplete': 'Some of the required fields of the form have not yet been filled out.',
        'records.last-modified': 'Last modified',
        'records.open-tooltip': 'View and edit the form',
        'records.delete-tooltip': 'Delete this form',
        'records.not-found': 'No forms were found...',
        'records.loading-error': 'Unable to load forms. {error}',
        ...
        'record.save-error': 'Unable to save form. {error}',
        'record.form.please-wait': 'Loading form, please wait...',
        'record.delete-success': 'Form deleted successfully',
        'record.delete-error': 'Unable to delete form. {error}',
        'record.load-error': 'Unable to load form. {error}',
        'record.load-form-error': 'Unable to form. {error}',

        'help.local-name': 'Purpose of this entry is your local identifier of form.',
        ...
        'statistics.number-of-processed-records': 'Number of processed forms',
        ...
        'The passed record\'s key is different from the specified one.': 'The passed form\'s key is different from the specified one.',
        ...
        'User with patient records cannot be deleted.': 'User with forms cannot be deleted.',
        ...
        'Institution with members or patient records cannot be deleted.': 'Institution with members or forms cannot be deleted.',
